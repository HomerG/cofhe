...
dbg_data = ccs0302_tasks.read_serial (ccs0302_header.GPCFG_N_ADDR[0])
...
#ccs0302_tasks.write_serial     (ccs0302_header.GPCFG_FHECTL3,          ccs0302_init_val.fhe_ctl2)
#ccs0302_tasks.write_serial     (ccs0201_header.GPCFG_FHECTLP_ADDR,    "00000200")
ccs0302_tasks.write_serial_256    (ccs0302_header.GPCFG_NSQ_ADDR[0],   ccs0302_init_val.fhe_bmd)      #barrett
ccs0302_tasks.write_serial        (ccs0302_header.GPCFG_NSQ_ADDR[5],   ccs0302_init_val.fhe_bk[2:])   #barrett
