...
def fhe_polymul_dp ():
  ...
  write_serial         (ccs0302_header.GPCFG_FHECTL2,       str(ccs0302_header.FHEMEM1_BASE[:-6] +  ccs0302_header.FHEMEM3_BASE[:-6] +  ccs0302_header.FHEMEM0_BASE[:-6] + ccs0302_header.FHEMEM0_BASE[:-6]))
  write_serial         (ccs0302_header.GPCFG_FHECTL_ADDR,  (str("0040" + ccs0302_init_val.fhe_polydeg[2:])))
  write_serial         (ccs0302_header.GPCFG_COMMNDFIFO,  str("C1" + ccs0302_header.FHEMEM2_BASE[:-6] + ccs0302_header.FHEMEM0_DP_BASE[:-6] + ccs0302_header.FHEMEM0_BASE[:-6]))
  print                (" << INFO: Triggered NTT A")
  write_serial         (ccs0302_header.GPCFG_COMMNDFIFO,  str("C1" + ccs0302_header.FHEMEM0_BASE[:-6] + ccs0302_header.FHEMEM1_DP_BASE[:-6] + ccs0302_header.FHEMEM1_BASE[:-6]))
  print                (" << INFO: Triggered NTT B")
