...
uartm_write    (.addr(INTLV2_RKEY_ADDR1),            .data(temp4_reg[63:32]));
uartm_write    (.addr(INTLV2_RKEY_ADDR2),            .data(temp4_reg[95:64]));
uartm_write    (.addr(INTLV2_RKEY_ADDR3),            .data(temp4_reg[127:96]));
...
//Version 0
//OSAT Unlock : Positive

uartm_write    (.addr(INTLV2_RKEY_ADDR0),            .data(temp4_reg[31:0]));
uartm_write    (.addr(INTLV2_RKEY_ADDR1),            .data(temp4_reg[63:32]));
uartm_write    (.addr(INTLV2_RKEY_ADDR2),            .data(temp4_reg[95:64]));
uartm_write    (.addr(INTLV2_RKEY_ADDR3),            .data(temp4_reg[127:96]));
