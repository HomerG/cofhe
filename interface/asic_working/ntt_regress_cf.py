...
file_ntt = open("./testcases/ntt_regress_cf.v", "w")
...
file_ntt.write ("uartm_write    (.addr(GPCFG_COMMNDFIFO_ADDR),  .data({8'h01, FHEMEM3_BASE[31:24], FHEMEM0_BASE[31:24], FHEMEM0_BASE[31:24]}));\n")
